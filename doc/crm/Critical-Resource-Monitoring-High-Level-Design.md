...
CRM_STATS_DASH_IPV4_DASH_ACL_GROUP_AVAILABLE     = 1*20DIGIT ; number of available entries for 'ipv4 acl group' resource
CRM_STATS_DASH_IPV6_DASH_ACL_GROUP_USED          = 1*20DIGIT ; number of used entries for 'ipv4 acl group' resource
CRM_STATS_DASH_DASH_IPV4_ACL_GROUP_AVAILABLE     = 1*20DIGIT ; number of available entries for 'ipv6 acl group' resource
CRM_STATS_DASH_DASH_IPV6_ACL_GROUP_USED          = 1*20DIGIT ; number of used entries for 'ipv6 acl group' resource
```
...
container sonic-crm {
    ...
    container CRM {
        ...
        container Config {
            ...
            /* For each resource the following attributes are defined: */
...
1. Verify command "crm config thresholds <resource> type"
2. Verify command "crm config thresholds <resource> low"
3. Verify command "crm config thresholds <resource> high" 
4. Verify command "crm show thresholds <resource>"
5. Verify command "crm show resources <resource>"
